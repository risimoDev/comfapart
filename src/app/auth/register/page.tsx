...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    // Валидация согласий
    const consentValidation = validateRegistrationConsents(consents)
    ...
    try {
      const response = await fetch('/api/auth/register', {
        ...
        body: JSON.stringify({
          ...
          // Передаем согласия для логирования
          consents: {
      ...
      >
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            {/* Согласия на обработку ПД (152-ФЗ) */}
          ...
          <div className="space-y-3">
            <button className="w-full px-4 py-3 border rounded-xl flex items-center justify-center gap-2 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
